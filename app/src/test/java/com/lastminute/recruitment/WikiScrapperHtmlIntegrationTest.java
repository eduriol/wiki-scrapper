...
@ActiveProfiles("html")
class WikiScrapperHtmlIntegrationTest {

    @Autowired
    private MockMvc mockMvc;

    @Test
    void shouldReturn204WhenScrapingValidLinkWithHtmlProfile() throws Exception {
        // given
    ...
    @Test
    void shouldReturn404WhenRootPageNotFoundWithHtmlProfile() throws Exception {
        // given
